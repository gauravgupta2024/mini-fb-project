...
const Hero = () => {
  return (
    <div className="flex flex-col justify-start items-center w-full h-[84vh] pt-24 ">
      <h1 className="text-[2rem] font-semibold flex justify-center items-center">
        {" "}
        <FaQuoteLeft className="mr-2 translate-y-[-30px]" />
        <span>Connect, Share, and Grow</span>
        <FaQuoteRight className="ml-2 translate-y-[-30px]" />
      </h1>
      <h4 className="w-[40%] text-center mb-8 text-[1.2rem]">
        Where your moments turn into meaningful connections. <br /> Join the
        community that amplifies your voice.
      </h4>

      <p className="text-[0.9rem] w-[60%] text-center">
